# -*- coding: utf-8 -*-
"""siamese_network_original1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dG-NLMFV80yNiJO8Wvqht0rZVaDESUfE
...
def siamese_model(x, y, batch_size=64, dropout=0.3, metrics='accuracy', epochs=150, pool_size=2, validation_split=0.2, summary=False, callbacks=None, checkpoint=None):
  ...
  siamese_model.compile(optimizer=Adam(), 
                loss=BinaryCrossentropy(), # We use BinaryCrossentropy is only get 1 result                                   
                metrics=[metrics])
...
callbacks = EarlyStopping(monitor='val_loss', mode='min', patience=15, verbose=1)
...
model.save('/content/siamese_model')
